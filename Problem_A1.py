...
def solution_A1():
    ...
    earlyStopping = keras.callbacks.EarlyStopping(monitor='loss',min_delta=1e-4,patience=100,verbose=1,restore_best_weights=True)
    model.fit(X,Y,epocs=500,callbacks=[earlyStopping])
